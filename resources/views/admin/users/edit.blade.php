                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" value="{{ $data_pegawai->name }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control"
                                                value="{{ $data_pegawai->tempat_lahir . ', ' . $data_pegawai->tanggal_lahir }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control"
                                                value="{{ $data_pegawai->jenis_kelamin == 'l' ? 'Laki-laki' : 'Perempuan' }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="text"
                                                    ...
                                                    name="email" value="{{ $data_pegawai->user_email }}" readonly>
                                                @error('email')
