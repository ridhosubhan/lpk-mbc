                        ...
                        <div class="row row-deck row-cards">
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <input type="hidden" class="form-control" value="{{ $data_pegawai->id }}"
                                            name="id_pegawai" id="id_pegawai" readonly>
                                        <div class="mb-3 row">
                                            <label class="col-4 col-form-label">Nama Lengkap</label>
                                            <div class="col">
                                                <input type="text"
                                                    class="form-control @error('nama') is-invalid @enderror"
                                                    value="{{ $data_pegawai->nama }}" name="nama" id="nama">
                                                @error('nama')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="text" class="form-control"
                                                    value="{{ $data_pegawai->email_user }}" name="email"
                                                    id="email" disabled>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <select class="form-select @error('jenis_kelamin') is-invalid @enderror"
                                                    ...
                                                    <option value="l"
                                                        {{ $data_pegawai->jenis_kelamin == 'l' ? 'selected' : '' }}>
                                                        Laki-laki
                                                    </option>
                                                    <option value="p"
                                                        {{ $data_pegawai->jenis_kelamin == 'p' ? 'selected' : '' }}>
                                                        Perempuan
                                                    </option>
                                                </select>
                                                @error('jenis_kelamin')
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="text"
                                                    ...
                                                    value="{{ $data_pegawai->tempat_lahir }}" name="tempat_lahir"
                                                    id="tempat_lahir">
                                                @error('tempat_lahir')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="date"
                                                    ...
                                                    value="{{ $data_pegawai->tanggal_lahir }}" name="tanggal_lahir"
                                                    id="tanggal_lahir">
                                                @error('tanggal_lahir')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat">{{ $data_pegawai->alamat }}</textarea>
                                                @error('alamat')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <select class="form-select @error('jenis_kelamin') is-invalid @enderror"
                                                    ...
                                                    <option value="guru"
                                                        {{ $data_pegawai->kat_pegawai == 'guru' ? 'selected' : '' }}>
                                                        Guru
                                                    </option>
                                                    <option value="tenaga_pendidik"
                                                        {{ $data_pegawai->kat_pegawai == 'tenaga_pendidik' ? 'selected' : '' }}>
                                                        Tenaga Pendidik
                                                    </option>
                                                </select>
                                                @error('jabatan')
