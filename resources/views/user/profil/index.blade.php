                        ...
                        <div class="row row-deck row-cards">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-2 row">
                                            <div class="col">
                                                <img src="{{ asset('storage/' . $profil_siswa->foto) }}"
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <input type="hidden" class="form-control" value="{{ $profil_siswa->id }}"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="text"
                                                    ...
                                                    value="{{ $profil_siswa->nama }}" name="nama" id="nama">
                                                @error('nama')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="text" class="form-control"
                                                    value="{{ $profil_siswa->email_user }}" name="email"
                                                    id="email" disabled>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <select class="form-select @error('jenis_kelamin') is-invalid @enderror"
                                                    ...
                                                    <option value="l"
                                                        {{ $profil_siswa->jenis_kelamin == 'l' ? 'selected' : '' }}>
                                                        Laki-laki
                                                    </option>
                                                    <option value="p"
                                                        {{ $profil_siswa->jenis_kelamin == 'p' ? 'selected' : '' }}>
                                                        Perempuan
                                                    </option>
                                                </select>
                                                @error('jenis_kelamin')
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="text"
                                                    ...
                                                    value="{{ $profil_siswa->tempat_lahir }}" name="tempat_lahir"
                                                    id="tempat_lahir">
                                                @error('tempat_lahir')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="date"
                                                    ...
                                                    value="{{ $profil_siswa->tanggal_lahir }}" name="tanggal_lahir"
                                                    id="tanggal_lahir">
                                                @error('tanggal_lahir')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat">{{ $profil_siswa->alamat }}</textarea>
                                                @error('alamat')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
